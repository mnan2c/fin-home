var FormWizard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            form.validate({
                doNotHideMessage: true, //this option enables to show the errors/success messages on tab switch.
                ...
                highlight: function (element) { // hightlight errors inputs
                    $(element)
                        .closest('.form-group').removeClass('has-success').addClass('has-error'); // set errors class to the control group
                },
                ...
                success: function (label) {
                    if (label.attr("for") == "gender" || label.attr("for") == "payment[]") { // for checkboxes and radio buttons, no need to show OK icon
                        label
                            .closest('.form-group').removeClass('has-errors').addClass('has-success');
                        label.remove(); // remove errors label here
                    } else { // display success icon for other inputs
                        label
                            .addClass('valid') // mark the current input as valid and display OK icon
                        .closest('.form-group').removeClass('has-errors').addClass('has-success'); // set success class to the control group
                    }
                },
